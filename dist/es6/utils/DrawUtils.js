...
export var DrawUtils = /*#__PURE__*/function () {
  ...
  _createClass(DrawUtils, null, [{
    ...
    value: function drawElement(element, ctx) {
      ...
      var outerRect = new RoundRect().applySize(element.rect.width, element.rect.height).applyRadius(style.borderTopLeftRadius, style.borderTopRightRadius, style.borderBottomLeftRadius, style.borderBottomRightRadius);
      var innerRect;
      ...
      if (style.shadow && style.shadow.isEnable()) {
        ...
        var shadowRect = new RoundRect(outerRect.x1 - x, outerRect.y1 - y, outerRect.x2 + x, outerRect.y2 + y);
        ctx.beginPath();
