...
export var DrawUtils = /*#__PURE__*/function () {
  ...
  _createClass(DrawUtils, null, [{
    ...
    value: function drawElement(element, ctx) {
      ...
      var outerRect = new RoundRect().applySize(element.rect.width, element.rect.height).applyRadius(style.borderRadiusTop, style.borderRadiusRight, style.borderRadiusBottom, style.borderRadiusLeft);
      var innerRect;
