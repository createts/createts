...
import { TextAlign } from '../style/Style';
 ...
 * ```
 */
export var BitmapText = /*#__PURE__*/function (_XObject) {
    ...
    value: function setBitmapTextSheet(bitmapTextSheet) {
      ...
      if (this.bitmapTextSheet) {
        if (this.bitmapTextSheet.url) {
          ResourceRegistry.DefaultInstance.add(this.bitmapTextSheet.url, ResourceType.IMAGE).then(function () {
        ...
        for (_iterator.s(); !(_step = _iterator.n()).done;) {
          ...
          try {
            for (_iterator2.s(); !(_step2 = _iterator2.n()).done;) {
              ...
              if (text) {
                var size = DrawUtils.getFrameSize(text, this.bitmapTextSheet);
          ...
          try {
            for (_iterator3.s(); !(_step3 = _iterator3.n()).done;) {
              ...
              if (_text) {
                var _size = DrawUtils.getFrameSize(_text, this.bitmapTextSheet);

                var rect = new Rect(x, y, _size.width, _size.height);
                DrawUtils.drawFrame(ctx, rect, _text, this.bitmapTextSheet);
