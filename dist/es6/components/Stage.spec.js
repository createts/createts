...
test('should dispatch mouse events', function () {
  ...
  stage.handleMouseOrTouchEvent('mousedown', [new TouchItem(0, undefined, 110, 100)], undefined); // Outside child.

  stage.handleMouseOrTouchEvent('mouseup', [new TouchItem(0, undefined, 80, 100)], undefined); // Outside child.
