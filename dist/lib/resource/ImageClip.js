...
var ImageClip = /*#__PURE__*/function () {
  _createClass(ImageClip, null, [{
    ...
    value: function of(clip) {
      ...
      return new ImageClip(matched[1], new _base.Rect(parseFloat(matched[2]), parseFloat(matched[3]), parseFloat(matched[4]), parseFloat(matched[5])), matched[6] ? parseInt(matched[6]) : 0);
    }
  }]);
  ...
  _createClass(ImageClip, [{
    ...
    value: function getImage() {
      return this.image ? this.image : _ResourceRegistry.ResourceRegistry.DefaultInstance.get(this.src);
    }
  }, {
    key: "getWidth",
