...
var BorderRadius = /*#__PURE__*/function () {
  _createClass(BorderRadius, null, [{
    ...
    value: function of(value) {
      ...
      if (typeof value === 'number') {
        return new BorderRadius(_BaseValue.BaseValue.of(value));
      } else {
        ...
        if (pieces.length === 1) {
          _value = value2 = _BaseValue.BaseValue.of(pieces[0]);
        } else if (pieces.length === 2) {
          _value = _BaseValue.BaseValue.of(pieces[0]);
          value2 = _BaseValue.BaseValue.of(pieces[1]);
        }
  ...
  _createClass(BorderRadius, [{
    ...
    value: function convertFrom(src) {
      ...
      if (result === undefined) {
        return new BorderRadius(_BaseValue.BaseValue.ZERO, _BaseValue.BaseValue.ZERO);
      } else {
        return result;
      }
    }
