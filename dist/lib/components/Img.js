...
var Img = /*#__PURE__*/function (_XObject) {
  ...
  function Img(options) {
    ...
    if (!_this.imageClip) {
      _this.imageClip = _ImageClip.ImageClip.of('');
    }
  ...
  _createClass(Img, [{
    ...
    value: function setSrc(src) {
      ...
      this.imageClip = _ImageClip.ImageClip.of(src);

      _ResourceRegistry.ResourceRegistry.DefaultInstance.add(this.imageClip.getSrc(), _ResourceRegistry.ResourceType.IMAGE).then(function (image) {
