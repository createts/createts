...
function (_Container) {
  ...
  _createClass(Stage, [{
    ...
    value: function dispatchTouchEvent(element, type, bubble, currentTouch, e) {
      var event = new _XObject.TouchEvent(element, type, bubble, currentTouch, this.touchedChildren.getTouches(element), true);
      event.stage = this;
      event.nativeEvent = e;
    ...
    value: function dispatchNonCancellableTouchEvent(element, type, bubble, currentTouch, e) {
      var event = new _XObject.TouchEvent(element, type, bubble, currentTouch, this.touchedChildren.getTouches(element), false);
      event.stage = this;
      event.nativeEvent = e;
      element.dispatchEvent(event);
    }
